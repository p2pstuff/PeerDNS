...
#   Copy the sections you want to modify to a .exs
#   file in the data/ directory and change them there.
#
#   Example data/config.exs config file:
#
#     use Mix.Config
#
...
config :peerdns, tld: [".p2p", ".mesh", ".h", ".hype", ".y", ".ygg"]
...
config :peerdns, yggdrasil_neighbors: [
  ...
  #yggdrasil_admin: {:tcp, "127.0.0.1", 9001},
  update_interval: 3600,
  api_port: 14123, weight: 0.5,
]
