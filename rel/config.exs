...
environment :dev do
  ...
  set cookie: :"]G{eNUq?U$DD9}Uyu<1IK)IjPBUN9zZgz/}B(3;P~]ngv9n*&CM,Ou&?$Wry~1m/"
end

environment :prod do
  set include_erts: true
  set include_src: false
  set cookie: :"IWg^aTim0[8%!~hUolKeuNEtECtiS$|reityU^rGp^p:OO}k^khQaPkYX3pxoBk/"
...
release :peerdns do
  set version: current_version(:peerdns)
  set applications: [
    :runtime_tools
  ]
end
